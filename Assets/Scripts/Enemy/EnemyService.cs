...
namespace CosmicCuration.Enemy
{
    public class EnemyService
    {
        ...
        public EnemyService(EnemyView enemyPrefab, EnemyScriptableObject enemyScriptableObject, Transform enemyParent)
        {
            this.enemyPrefab = enemyPrefab;
            this.enemyScriptableObject = enemyScriptableObject;
            enemyPool = new EnemyPool(enemyPrefab, enemyScriptableObject, enemyParent);
            InitializeVariables();
        }
